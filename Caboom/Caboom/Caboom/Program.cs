...
");
            ...
            else
            {
                ...
                {
                    string inf = path + "\\" + argument;
                    if (File.Exists(inf))
                    {
                        if (argument.Contains(".\\"))
                        {
                            string newarg = argument.Replace(".\\", "");
                            //Console.WriteLine("--DEBUG-- NEW IS " + newarg);
                            if (Path.GetExtension(inf).Equals(".inf"))
                            {
                                Console.WriteLine(newarg + " FOUND!\n Generating your .cab . . .\n");
                                system("move " + newarg + " ..");
                                Sleep(2000);
                                system(".\\CABARC.EXE -p -m NONE n ministry.cab ../" + newarg);
                                Sleep(1000);
                            ...
                            {
                                Console.WriteLine(newarg + " FOUND!\n Generating your .cab . . .\n");
                                string newFile = Path.ChangeExtension(newarg, ".inf");
                                system("copy " + newarg + " " + newFile);
                                system("move " + newFile + " ..");
                                Sleep(2000);
                        ...
                        else if (File.Exists(inf))
                        {

                            //Console.WriteLine("--DEBUG2-- IT IS " + argument);
                            if (Path.GetExtension(inf).Equals(".inf"))
                            {
                    ...
                    {
                        Console.WriteLine("Not found or not supported.");
                    }
                }
                else
                {
